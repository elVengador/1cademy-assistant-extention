    ...
    messages: [
      {
        ...
        message: {
          type: "HELP",
          content:
            "Hey Carl, How can I help you today? Select one of the following options or type your question.",
        },
        uname: "bot",
      },
      {
      ...
      },
      {
        ...
        hour: "20:00",
        image: "",
        message: { type: "NORMAL", content: "klkljg" },
        uname: "bot",
      },
      {
        type: "WRITER",
...
export const Chat = () => {
  ...
  return (
    ...
    >
      ...
      >
        <CustomAvatar
          imageUrl={OneCademyAssistantLogo}
                          ...
                          {c.message.type === "HELP" && (
                            <>
                              ...
                              <Button variant="outlined" fullWidth>
                                Teach me the content of this page
                              </Button>
                            </>
                          )}
                        </Stack>
